...
public partial class ventanaSSA : Form
{
    ...
    private void btnAceptar_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            {
                cantidadErrores++;
                stringErrores[cantidadErrores - 1] = "ERROR: " + this.lblError.Text + ": Debe indicar un valor mayor o igual a 0 para el % error.";
            }
            if (ptoVerdeExp.Visible)
            {
                cantidadErrores++;
                stringErrores[cantidadErrores - 1] = "ERROR: " + this.lblExpIDW.Text + ": Debe indicar un valor real entre 0 y 100 para el exponente del metodo IDW.";
            }
    ...
    private void txtRango_LostFocus(object sender, EventArgs e)
    {
        try
        {
            int i;
            int cantMuestras;
            if (int.TryParse(this.txtRango.Text, out i) && (i>0))
            {
                if (i != rangoAux)
                {
                    Fabrica fabrica = Fabrica.getInstancia;
    ...
    {
        double i;
        if (double.TryParse(this.txtError.Text, out i) && (i>=0))
        {
    ...
    {
        int.TryParse(this.txtRango.Text.ToString(),out rangoAux);
        this.panelAyuda.Controls.Clear();
    ...
    {
        double i;
        if (double.TryParse(this.txtExpIDW.Text, out i) && (i>=1) && (i<=100))
        {
            this.ptoVerdeExp.Visible = false;
    ...
    private void txtExpIDW_GotFocus(object sender, EventArgs e)
    {
        this.panelAyuda.Controls.Clear();
    ...
    {
        int i;
        if (int.TryParse(this.txtCantMuestras.Text, out i) && (i>0))
        {
            this.ptoVerdeMuestras.Visible = false;
    ...
    private void txtCantMuestras_GotFocus(object sender, EventArgs e)
    {
        this.panelAyuda.Controls.Clear();
